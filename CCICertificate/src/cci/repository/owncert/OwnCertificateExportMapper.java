...
public class OwnCertificateExportMapper<T> implements RowMapper<OwnCertificateExport> {
	 Company beltpp;
   	 
 	 private static final Logger LOG = Logger
			.getLogger(JDBCOwnCertificateDAO.class);
   	 	
	 public OwnCertificateExport mapRow(ResultSet resultSet, int row) throws SQLException {
		 OwnCertificateExport cert = new OwnCertificateExport();
